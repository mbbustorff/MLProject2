...
plt.text(0.03, 3, "Minimum test error: " + str(np.round(min_error*100,2)) + ' % at 1e' + str(np.round(np.log10(opt_lambda),2)),fontsize=16)
plt.xlabel('Regularization strength, $\log_{10}(\lambda)$', fontsize=16)
plt.ylabel('Error rate (%)', fontsize=16)
plt.title('Classification error', fontsize=16)
